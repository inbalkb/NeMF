# This file contains the code for real-world AirMSPI cloud dataset loaders for NeMF.
...
ALL_DATASETS_AIRMSPI = ("BOMEX_aux_9cams_polarization", 
                        "32N123W_experiment_cloud1")
...
def get_microphysics_airmspi_datasets(
    ...
    if dataset_name == 'BOMEX_aux_9cams_polarization':
        cloud_train_path = os.path.join(data_root, 'BOMEX_256x256x100_5000CCN_50m_micro_256/new_clouds/train') # use 3D microphysics from here
