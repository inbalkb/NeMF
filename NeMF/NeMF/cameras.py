# This file contains the code for camera object for NeMF.
...
class PerspectiveCameras(TensorProperties):
    ...
    def project_points_shdom(
        self, points, eps: Optional[float] = None, screen: bool = False
    ) -> torch.Tensor:
        """
        Transforms points from world space to screen space  using input of data generated by SHDOM.
    ...
    def project_points_at3d(
        ...
        """
        Transforms points from world space to screen space using input of data generated by AT3D ('https://github.com/CloudTomography/AT3D').
		This function is for future usage.
        Input points follow the AT3D coordinate system conventions: +X[km] (East), +Y [km] (North), +Z[km] (Up).
        Output points are in screen space: +X right, +Y down, origin at top left corner.
