# This file contains the main NeMF framework code.
...
class NeMFnetAirMSPI(torch.nn.Module):
    ...
    def forward(
        ...
        if self.training:
            ...
            latent = self._image_encoder.sample_roi(image_features, uv)
            del image_features
            if self.stop_encoder_grad:
                latent = [lat.detach() for lat in latent]
