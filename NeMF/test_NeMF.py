# This file contains the main script for NeMF evaluation.
...
from NeMF.microphysics_dataset import get_cloud_microphysics_datasets, trivial_collate
from NeMF.NeMFnet import *
from NeMF.util.plot_util import *
...
def main(cfg: DictConfig):
    ...
    for test_i, test_batch in enumerate(test_dataloader):
        ...
        with (torch.no_grad()):
            ...
            if 0 : # for saving cloud in mat file
            ...
            if 0:  # for showing clouds visualization plots
            ...
            if 0:  # for calculation of the inferred PDF
