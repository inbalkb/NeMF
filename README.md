...
You can download the simulated cloud data and real-world AirMSPI files [here](https://technionmail-my.sharepoint.com/:f:/g/personal/hybridlab_technion_ac_il/IgDm2Io52N4wQYBgZHhg0aInARVtqnYvMX2LnyycZLYdMPE?e=oJggfS).
...
### Trained NeMF models
The NeMF trained models can be found [here](https://technionmail-my.sharepoint.com/:f:/g/personal/hybridlab_technion_ac_il/IgDm2Io52N4wQYBgZHhg0aInARVtqnYvMX2LnyycZLYdMPE?e=oJggfS).
